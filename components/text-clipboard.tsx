  ...
  return (
    <div className="space-y-4 w-full min-w-0">
      ...
      <Textarea
        ...
        className="h-64 sm:h-80 min-h-48 max-h-[70vh] w-full max-w-full resize-none sm:resize-y overflow-y-auto overflow-x-hidden break-words [overflow-wrap:anywhere]"
        disabled={isUpdating}
      />
